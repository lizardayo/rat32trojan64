...
local Window = library:AddWindow("Lizard", {
...
local ESP = loadstring(game:HttpGet("https://raw.githubusercontent.com/lizardayo/trojanlol/main/trojan2.lua"))()
ESP:Toggle(false)
ESP.Tracers = false
ESP.Names = false
ESP.Boxes = false
...
local themes = {
    ...
    DarkContrast = Color3.fromRGB(166, 166, 166),  
...
local ALTab = Window:AddTab("Silent Aim")
...
local CreditTAB = Window:AddTab("Creds")

local folder = AnimTab:AddFolder("Animations")
folder:AddButton("Animation Gui", function(bool)
    loadstring(game:HttpGet("https://raw.githubusercontent.com/lizardayo/trojkanv9/main/troajn3.lua"))()
end)
...
CreditTAB:AddButton("Made by lizard#1000", function(bool)
    setclipboard("lizard#1000")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
...
CreditTAB:AddButton("Join discord.gg/ndev", function(bool)
    setclipboard("https://discord.gg/ndev")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
...
RCTab:AddButton("Click if u want my dick ", function(bool)
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Kphta/fake-macro/mainr/fake"))()
end)
 
RCTab:AddLabel("ndev ot")
...
RCTab:AddLabel("For u broke niggas")
...
ESPTab:AddSwitch("Click this for esp to work", function(bool)
    ESP:Toggle(bool)
end)
 
ESPTab:AddSwitch("Tracers", function(bool)
    ESP.Tracers = bool
end)
 
ESPTab:AddSwitch("Names and distances", function(bool)
    ESP.Names = bool
end)
 
ESPTab:AddSwitch("Boxes", function(bool)
    ESP.Boxes = bool
end)
...
ALTab:AddSwitch("Hardlock", function(bool)
    DaHoodSettings.AimLock = bool
end)
 
ALTab:AddSwitch("In dev", function(bool)
...
ALTab:AddSwitch("idk what this does", function(bool)
    DaHoodSettings.Cop = bool
end)
 
 
ALTab:AddSwitch("USE THIS IF U HAVE HIGH PING", function(bool)
...
AimTab:AddSwitch("ion even know why this here i just pasted this shit lol", function(bool)
end)
...
pcall(function()
    game.StarterGui:SetCore("SendNotification", {
      ...
      Text = 'Join our discord, https://discord.gg/ndev';
      Duration = 40;
    })
